...
net_csvs = ['s27.csv','s382.csv','s420.csv','s641.csv', 's27_trojan1.csv', 's27_trojan2.csv']
Xs = np.empty((1,9))
...
labeled_csvs = ['s27_trojan1.csv','s27_trojan2.csv']
Ys = np.empty((1,9))
...
for net in Zs:
    if(net[9] == 0 and res[i] != 0):
        FN += 1
    elif(net[9] != 0 and res[i] == 0):
        FP += 1
